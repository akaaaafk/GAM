...
"""
GAM 框架 + HotpotQA 数据集测试文件

基于 test_gam_longbench.py，适配 HotpotQA 数据集格式。
HotpotQA 数据格式：
- context: str - 长文本上下文
- input: str - 问题
- index: int - 索引
...
def main():
    ...
    parser = argparse.ArgumentParser(description="GAM 框架 + HotpotQA 数据集测试")
